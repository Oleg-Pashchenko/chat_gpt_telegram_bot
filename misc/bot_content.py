...
### Sports ###
sport_types = {
    "Футбол": "1) Кто победит? 2) Сколько минимум голов будет забито? 3) Сколько максимум голов будет забито? 4) Обе забьют или нет? 5) Какой будет счёт? 6) Будет ли пенальти? 7) Будет ли гол в первом тайме? 8) Будет ли гол во втором тайме? 9) Обе забьют в первом тайме? 10)Обе забьют во втором тайме? 11) Кто победит в первом тайме? 12) Кто победит во втором тайме?",
    "Баскетбол": "",
    "Теннис": "",
    "Воллейбол": "",
}
